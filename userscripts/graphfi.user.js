// ==UserScript==
// @name           GraphFi
// @description    Convert GraphFi bookmarklet to a userscript
// @include        http://metafilter.com/*
// @include        http://*.metafilter.com/*
// @include        https://metafilter.com/*
// @include        https://*.metafilter.com/*
// @author         Charlie DeTar, conversion to userscript Sarah Tisdale
// @grant          none
// ==/UserScript==
...
//window.setTimeout(initialize, 0);  // Uncomment this one to turn GraphFi on all the time
window.setTimeout(pre_initialize, 0);

function pre_initialize() {
    // Stick a link somewhere to enable GraphFi
    ...
    $(".posttitle > span").append("&nbsp;&nbsp;");
    $(".posttitle > span").append(a);
}
